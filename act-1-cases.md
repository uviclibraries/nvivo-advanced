...
2.	**Launch NVivo.**
When the program opens, click **Create New Project** in the top-right corner to open a new project.
...
In the project setup window, enter a project name, choose a save location, and add a description. For this exercise, we recommend naming your project **Biography Analysis.**
    ...
    <img src="images/NVivo15/2-CreateNewProject.png" alt="hierarchy chart" style="width:500px; margin-left:10px;">
